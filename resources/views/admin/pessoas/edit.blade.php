        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form action="{{ route("admin.pessoas.update", [$pessoa->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group {{ $errors->has('tipo') ? 'has-error' : '' }}">
                            ...
                            @foreach(App\Pessoa::TIPO_RADIO as $key => $label)
                                <div>
                                    <input id="tipo_{{ $key }}" name="tipo" type="radio" value="{{ $key }}" {{ old('tipo', $pessoa->tipo) === (string)$key ? 'checked' : '' }} required>
