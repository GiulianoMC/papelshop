        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.edit') }} {{ trans('cruds.categoria.title_singular') }}
                </div>
                <div class="panel-body">
                    ...
                    <form action="{{ route("admin.categorias.update", [$categoria->id]) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('nome') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="nome" name="nome" class="form-control" value="{{ old('nome', isset($categoria) ? $categoria->nome : '') }}" required>
                            @if($errors->has('nome'))
                                <p class="help-block">
                                    {{ $errors->first('nome') }}
                                </p>
